...
const urlRef = ref("http://localhost:9090/api/supervisors/newSupervisor");
...
<template>
  ...
  <div class="container mb-4">
    ...
    <div class="mb-2">
      ...
      <input class="form-control" id="phone" v-model="formDataRef.phone" type="text" />
    </div>
    <div class="">
      <button class="btn btn-primary" @click="onSubmit" type="button">Create new Supervisor</button>
    </div>
  </div>
</template>